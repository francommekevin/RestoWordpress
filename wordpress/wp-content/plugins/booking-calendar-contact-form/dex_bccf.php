...
$codepeople_promote_banner_plugins[ 'booking-calendar-contact-form' ] = array( 
                      ...
                      'plugin_url'  => 'https://wordpress.org/support/plugin/booking-calendar-contact-form/reviews/#new-post'
);
...
function dex_bccf_helpLink($links) {
	...
	$s_link = '<a href="https://bccf.dwbooster.com/support?priority=1">'.__('Documentation','bccf').'</a>';
	array_unshift($links, $s_link);
	return $links;
}

function dex_bccf_customAdjustmentsLink($links) {
    $customAdjustments_link = '<a href="https://bccf.dwbooster.com/download">'.__('Upgrade To Premium','bccf').'</a>';
