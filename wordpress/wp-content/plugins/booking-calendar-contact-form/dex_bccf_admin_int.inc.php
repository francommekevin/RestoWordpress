...
<option value="THB"<?php if ($currency == 'THB') echo ' selected'; ?>>THB - Thai Baht</option>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td>
           <em>This feature is available in the <a href="https://bccf.dwbooster.com/download">pro version</a>.</em>          
        </td>
        </tr>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     ...
     <em>* Note: The Form Builder isn't available in this version. For a version with a fully functional Form Builder <a href="https://bccf.dwbooster.com/download">check the pro version</a>.</em>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     ...
     <table class="form-table">
        <tr valign="top">
         <td width="1%" nowrap><strong>"is required" text:</strong><br /><input type="text" required name="vs_text_is_required" size="40" value="<?php echo esc_attr(dex_bccf_get_option('vs_text_is_required', DEX_BCCF_DEFAULT_vs_text_is_required)); ?>" /></td>
         <td><strong>"is email" text:</strong><br /><input type="text" required name="vs_text_is_email" size="70" value="<?php echo esc_attr(dex_bccf_get_option('vs_text_is_email', DEX_BCCF_DEFAULT_vs_text_is_email)); ?>" /></td>
        </tr>
        <tr valign="top">
